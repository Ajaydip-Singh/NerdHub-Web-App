...
const productSchema = new mongoose.Schema(
  {
    ...
    numReviewsColor: { type: String, required: true },
    isCardActiveReviews: { type: Boolean, required: true, default: true },
    isPageActiveReviews: { type: Boolean, required: true, default: true },
